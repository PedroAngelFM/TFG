 ...
 \centering
  \subfloat[Regresión Lineal]{
   \label{fig:regresion_lineal}
    \includegraphics[width=0.2\textwidth]{Documentos Extra/Imagenes/Datos PruebasRegresionLineal.png}}
  \subfloat[Árbol de regresión]{
   \label{fig:regression_tree}
    \includegraphics[width=0.2\textwidth]{Documentos Extra/Imagenes/Datos PruebasÁrbolesRegresion.png}}
    \subfloat[Red neuronal]{
   \label{fig:red_neuronal}
    \includegraphics[width=0.2\textwidth]{Documentos Extra/Imagenes/Datos PruebasRedNeuronal.png}}
 \caption{Gráficos de comparación de los valores predichos con el valor real.}
  \label{fig: comparación}
\end{figure}

\noindent En resumen, el mejor modelo para predecir la resistencia a la compresión sería la red neuronal. 
